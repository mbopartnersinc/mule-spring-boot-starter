...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
	...
	static {
		try {
			javaUtilOptionalClass =
					ClassUtils.forName("java.util.Optional", org.springframework.beans.factory.support.DefaultListableBeanFactory.class.getClassLoader());
		}
		...
		try {
			javaxInjectProviderClass =
					ClassUtils.forName("javax.inject.Provider", org.springframework.beans.factory.support.DefaultListableBeanFactory.class.getClassLoader());
		}
		catch (ClassNotFoundException ex) {
	...
	private static final Map<String, Reference<org.springframework.beans.factory.support.DefaultListableBeanFactory>> serializableFactories =
			new ConcurrentHashMap<String, Reference<org.springframework.beans.factory.support.DefaultListableBeanFactory>>(8);
	...
	public void setSerializationId(String serializationId) {
		if (serializationId != null) {
			serializableFactories.put(serializationId, new WeakReference<org.springframework.beans.factory.support.DefaultListableBeanFactory>(this));
		}
		...
		if (autowireCandidateResolver instanceof BeanFactoryAware) {
			if (System.getSecurityManager() != null) {
				AccessController.doPrivileged(new PrivilegedAction<Object>() {
					@Override
					public Object run() {
						((BeanFactoryAware) autowireCandidateResolver).setBeanFactory(org.springframework.beans.factory.support.DefaultListableBeanFactory.this);
						return null;
					}
	...
	public void copyConfigurationFrom(ConfigurableBeanFactory otherFactory) {
		...
		if (otherFactory instanceof org.springframework.beans.factory.support.DefaultListableBeanFactory) {
			org.springframework.beans.factory.support.DefaultListableBeanFactory otherListableFactory = (org.springframework.beans.factory.support.DefaultListableBeanFactory) otherFactory;
	...
	protected boolean isAutowireCandidate(String beanName, DependencyDescriptor descriptor, AutowireCandidateResolver resolver)
		...
		BeanFactory parent = getParentBeanFactory();
		if (parent instanceof org.springframework.beans.factory.support.DefaultListableBeanFactory) {
			// No bean definition found in this factory -> delegate to parent.
			return ((org.springframework.beans.factory.support.DefaultListableBeanFactory) parent).isAutowireCandidate(beanName, descriptor, resolver);
		}
	...
	protected boolean isPrimary(String beanName, Object beanInstance) {
		...
		BeanFactory parent = getParentBeanFactory();
		return (parent instanceof org.springframework.beans.factory.support.DefaultListableBeanFactory &&
				((org.springframework.beans.factory.support.DefaultListableBeanFactory) parent).isPrimary(beanName, beanInstance));
	}
	...
	private void checkBeanNotOfRequiredType(Class<?> type, DependencyDescriptor descriptor) {
		...
		BeanFactory parent = getParentBeanFactory();
		if (parent instanceof org.springframework.beans.factory.support.DefaultListableBeanFactory) {
			((org.springframework.beans.factory.support.DefaultListableBeanFactory) parent).checkBeanNotOfRequiredType(type, descriptor);
		}
	}
